"""QTGMC, separated into its own submodule to more easily maintain the code."""
import math
...
from .helpers import AverageFrames, Weave
...
def QTGMC(
    ...
    try:
        ...
        raise ModuleNotFoundError("QTGMC: 'Missing dependency \"mvsfunc\"!'")
